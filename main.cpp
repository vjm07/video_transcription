...
// void whisper_print_usage(int argc, char ** argv, const whisper_stream_params & params);

// bool whisper_params_parse(int argc, char ** argv, whisper_stream_params & params) {
